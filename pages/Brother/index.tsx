    ...
    try {
      ...
      if (editRow.status !== "확정") {
        ...
        if (patch.engine_type !== (editRow.engine_type ?? null))
          changes.push({ label: "엔진형식", before: editRow.engine_type ?? "-", after: patch.engine_type ?? "-" });
                ...
                <div className="px-4 md:px-3.5 py-5 grid grid-cols-1 md:grid-cols-2 gap-3">
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="space-y-2 mt-1">
                      ...
                      {r.status === "확정" && (canActuallyUploadVehicleRegDoc || canUploadTaxInvoice || isAdminLevel) && (
                        <div className="flex flex-wrap gap-1.5">
                          {canActuallyUploadVehicleRegDoc && (
                            <button
                              disabled={
