...
const ExportOverviewPage: React.FC = () => {
  ...
  return (
    <div className="max-w-7xl mx-auto px-6 md:px-8 lg:px-10 space-y-12">
      {/* ===================== PAGE HEADER ===================== */}
      <section className="pt-10 md:pt-14 border-b border-gray-200 pb-8">
        <div className="grid md:grid-cols-12 gap-6 md:gap-8 items-start">
          <div className="md:col-span-7 space-y-4">
            ...
            <div className="text-sm font-semibold tracking-[0.16em] uppercase text-orange-500">
              EXPORT SHOP
            </div>

            <h1 className="text-4xl md:text-5xl font-semibold text-navy-900 tracking-tight">
              수출용 쇼핑몰
            </h1>
            ...
            <div className="rounded-3xl border border-orange-200 bg-orange-50 p-5 shadow-sm">
              <div className="flex items-start gap-3">
                ...
                <div className="min-w-0 w-full">
                  ...
                  <p className="mt-2 text-sm text-gray-700 leading-relaxed break-keep">
                  ...
                  <div className="mt-4 grid grid-cols-1 sm:grid-cols-[1fr_auto] gap-3 items-center">
                    ...
                    <a
                      ...
                      target="_blank"
                      rel="noreferrer"
                      className="inline-flex items-center justify-center px-4 py-2 rounded-xl bg-orange-500 text-white font-semibold text-sm hover:bg-orange-600 transition-all w-full sm:w-auto whitespace-nowrap"
            ...
            <div className="rounded-3xl border border-gray-200 bg-white p-5 shadow-sm">
              <div className="flex items-start gap-3">
                ...
                <div className="min-w-0 w-full">
                  ...
                  <p className="mt-2 text-sm text-gray-700 leading-relaxed break-keep">
                    정비·점검·등급화 및 상품화는 <b className="text-navy-900">현대지게차경기북부판매</b> 협력 체계로 진행합니다.
                  </p>
                  ...
                  <div className="mt-4 grid grid-cols-1 sm:grid-cols-[1fr_auto] gap-3 items-center">
                    ...
                    <div className="inline-flex items-center justify-center px-4 py-2 rounded-xl border border-gray-200 bg-gray-50 text-gray-700 font-semibold text-sm w-full sm:w-auto whitespace-nowrap">
                      정비/상품화 파트너
                    </div>
                  </div>
                </div>
